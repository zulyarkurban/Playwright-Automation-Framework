...
class PlaywrightServiceConfig {
    constructor() {
        this.setOptions = (options) => {
            ...
            if (!process.env[constants_1.InternalEnvironmentVariables.MPT_SERVICE_RUN_ID]) {
                if (options === null || options === void 0 ? void 0 : options.runId) {
                    this.runId = options.runId;
                    process.env[constants_1.InternalEnvironmentVariables.MPT_SERVICE_RUN_ID] = this.runId;
                }
                else {
                    this.runId = (0, utils_1.getAndSetRunId)();
                }
            }
            if (!process.env[constants_1.InternalEnvironmentVariables.MPT_SERVICE_RUN_NAME] && (options === null || options === void 0 ? void 0 : options.runName)) {
                this.runName = options.runName;
                process.env[constants_1.InternalEnvironmentVariables.MPT_SERVICE_RUN_NAME] = this.runName;
            }
